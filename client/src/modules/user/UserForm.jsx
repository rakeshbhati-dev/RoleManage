...
function UserForm() {
  ...
  return (
    <div className='w-full md:w-1/2 mx-auto mt-5 bg-white shadow-md rounded-xl'>
      <Form moduleName="user" onSubmit={submitHandler} isEdit={canEdit||false} initialData={initialData||{}}>
        <div className='my-2'>
          <p>Select Role</p>
